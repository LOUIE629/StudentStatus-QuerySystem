        ...
        if usr_name in usrs_info:
            if usr_pwd == usrs_info[usr_name]:
                ...
                def student_id():
                    ...
                    db = pymysql.connect(host='139.9.119.34', port=3306, user='s2018300356', password='GaussDB@123',
                                         database='2018300356')
                    cursor = db.cursor()
                ...
                def student_select():
                    ...
                    def select():
                        try:
                            usr_cno = cno_in.get()
                            db = pymysql.connect(host='139.9.119.34',port=3306,user='s2018300356',password='GaussDB@123',database='2018300356')
                            cursor = db.cursor()
                ...
                def teacher_idupdate():
                    ...
                    def insert():
                        try:
                            ...
                            student_college = var_student_college.get()
                            db = pymysql.connect(host='139.9.119.34', port=3306, user='s2018300356',
                                                 password='GaussDB@123', database='2018300356')
                            cursor = db.cursor()
